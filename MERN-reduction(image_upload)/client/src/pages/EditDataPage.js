...
/* 
  ...
  render() { 
    ...
    return (
      <Page title="Edit School" breadcrumbs={[{ name: 'Edit school', active: true }]}>
        <Row>
          <Col xl={12} lg={12} md={12}>
            <Card>
              <CardHeader>Edit SCHOOL</CardHeader>
              <CardBody>
                <Form onSubmit={this.handleSubmit}>
                  <Row>
                    ...
                    <Col md={5}></Col>
                    <Col md={7}>&nbsp;&nbsp;
                    <Button className="btn btn-primary" type="submit">Update SchoolData</Button>
                    </Col>
                  </Row>
                </Form>
              </CardBody>
